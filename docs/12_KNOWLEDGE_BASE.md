...
Лимиты: 25 МБ/файл (зашит в код — `knowledge.controller`); лимит документов на
проект НЕ реализован — backlog D-16 (пометка по аудиту IR-059, раньше здесь
обещалась «настройка установки»). Файлы и
